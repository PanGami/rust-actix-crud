...
use crate::config::types::ErrorMessage;

const AUDIENCE_URL: &'static str = "https://example.com/";
const AUTHORITY_URL: &'static str = "https://example.auth0.com/";
const JWKS_URL: &'static str = "https://example.auth0.com/.well-known/jwks.json";
